...
export function useCreateMutation<TDatabase extends Record<string, RecordModel>, TCollection extends keyof TDatabase & string>(collectionName: TCollection): UseCreateMutationResult<CollectionRecord<TDatabase, TCollection>>;
