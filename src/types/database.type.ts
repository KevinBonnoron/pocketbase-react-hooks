...
export type AuthCollectionRecord<TDatabase extends Record<string, RecordModel>, TCollection extends keyof TDatabase> = TDatabase[TCollection] extends AuthRecord
